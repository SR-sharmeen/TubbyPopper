...
public class GameActivity extends SimpleBaseGameActivity implements IOnMenuItemClickListener {
    ...
    int Score = 0;
    int life = 3;
    private Sprite plus10 = null;
    private Text scoreTextDisplay;
    private Text livesTextDisplay;
    private Text elapsedTimeDisplay;
    private String scoreText;
    private Sound popSound;
    private Sound dyingBeep;
    private Music bgMusic;
    private Sound boom;
    private int time = 180;
    private boolean isPaused = false;
    private ArrayList<Sprite> thePoppables;
